...
const WORDS = ["Software Developer", "Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/NaveenPodilikuri" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/naveen-podilikuri/" },
  { icon: Instagram, link: "https://www.instagram.com/just_.naveen/" },
];
